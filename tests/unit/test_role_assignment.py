...
sys.modules['tournament_bot.models.dbc_model'] = MagicMock()
sys.modules['tournament_bot.models.dbc_model.Tournament_DB'] = MagicMock()
sys.modules['tournament_bot.models.dbc_model.Game'] = MagicMock()
sys.modules['tournament_bot.models.dbc_model.Player'] = MagicMock()
