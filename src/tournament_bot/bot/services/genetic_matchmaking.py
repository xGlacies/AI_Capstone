...
import random
import json
from tournament_bot.models.dbc_model import Tournament_DB, Game, Player
...
class GeneticMatchMaking:
    ...
    async def load_players_from_json(self, count=10):
        ...
        try:
            ...
            from tournament_bot.bot.services.matchmaking import get_random_players
    ...
    async def calculate_player_tier(self, player):
        ...
        try:
            ...
            from tournament_bot.bot.services.matchmaking import calculate_player_tier
